...
public class UsersActivity extends AppCompatActivity {
    ...
    public void addItem(View view) {
        ...
        item.setLastName(mTextNewToDo.getText().toString());
    ...
    */
    ...
    public void configureInviteButton(){
        Button InviteScreen = (Button)findViewById(R.id.invitebutton);
        InviteScreen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent InviteIntent = new Intent(UsersActivity.this,InvitationActivity.class);
                currentUser = getIntent().getExtras().get("groupName").toString();
