...
public class BrandNewGroupActivity extends AppCompatActivity {
     ...
     */
    private MobileServiceTable<GroupTeam> mPersonTable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            mPersonTable = mClient.getTable(GroupTeam.class);
     ...
     *            The item to mark
     */
    public void checkItem(final GroupTeam item) {
        if (mClient == null) {
            return;
        }
     ...
     *            The item to mark
     */
    public void checkItemInTable(GroupTeam item) throws ExecutionException, InterruptedException {
    ...
    public void addItem(View view) {
        ...
        // Create a new item
        final GroupTeam item = new GroupTeam(mTextNewToDo.getText().toString());
        ...
        AsyncTask<Void, Void, Void> task = new AsyncTask<Void, Void, Void>(){
            ...
            protected Void doInBackground(Void... params) {
                try {
                    final GroupTeam entity = addItemInTable(item);
     ...
     *            The item to Add
     */
    public GroupTeam addItemInTable(GroupTeam item) throws ExecutionException, InterruptedException {
        GroupTeam entity = mPersonTable.insert(item).get();
        return entity;
    }
    ...
    private void refreshItemsFromTable() {
        ...
        AsyncTask<Void, Void, Void> task = new AsyncTask<Void, Void, Void>(){
            ...
            protected Void doInBackground(Void... params) {
                ...
                try {
                    final List<GroupTeam> results = refreshItemsFromMobileServiceTable();
    ...
    private List<GroupTeam> refreshItemsFromMobileServiceTable() throws ExecutionException, InterruptedException {
        FirebaseAuth mAuth = FirebaseAuth.getInstance();
        FirebaseUser user= mAuth.getCurrentUser();
        String currentEmail = user.getEmail();
        return mPersonTable
                .where()
                .field("EmailAddress").eq(currentEmail)
                .select("Name")
                .execute()
                .get();
